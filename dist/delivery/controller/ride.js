...
const usecase_1 = require("../../domain/usecase/usecase");
const ride_2 = require("../../infrastructure/provider/repository/ride");
const ride_3 = require("../../infrastructure/provider/validate/ride");
...
class CalculateRideEstimateController {
    calculateRideEstimate(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const validate = new ride_3.CalculateRideEstimateUseCaseValidate();
            const repository = new ride_2.CalculateRideEstimateUseCaseRepository();
            const usecase = new usecase_1.CalculateRideEstimateUseCase(validate, repository);
